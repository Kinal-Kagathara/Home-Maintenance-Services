...
<footer>
	...
	<p id="para">
		<b style="font-size:25;font-weight:900;font-family:segoe ui;color:orange;">
		<u>Mail</u> <u>Us</u></b> 
		: <a href="" id="atag">homemaintainance2024@gmail.com</a>
	</p>
	<p id="para">
	...
	if(isset($_POST['submit']))
	{
		...
		if($cn)
		{
			...
			if($db)
			{
				...
				$q=mysqli_query($cn,"insert into client_service_details values(NULL,'$e','$serId','$subid[0]','$serPId','$address','$d','0000-00-00',0,0)");
							...
							if($query_three)
							{
								...
								if($query_four)
								{
									...
									if($query_five)
									{
										...
										$e=$e;
										$from = "HomeServices <homemaintainance2024@gmail.com>";
										$to = "<$e>";
										...
										$host = "smtp.gmail.com";
										$port = "587";
										$username ="homemaintainance2024@gmail.com";
										$password ="asopkkau";
